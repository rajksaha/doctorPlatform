...
function getPrescribedVital($appointmentID){
	...
	$sql = "SELECT vp.`id`, vp.`appointMentID`, vp.`vitalID`, vp.`vitalResult` , IF(v.shortName IS NULL or v.shortName = '', v.shortName,   v.shortName) AS vitalDisplayName, v.vitalUnit 
