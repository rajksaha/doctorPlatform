...
function Show_med($appointmentID, $xAxis, $yAxis, $size){
	...
	if(mysql_num_rows($resultData) > 25){
		$size = $size - 2;
	}
...
//$pdf->Line($rightXaxis - 10 , 50, $rightXaxis - 10, $rightYaxis + 5, $linestyle);
...
$pdf->Line($rightXaxis - 5 , 50, $rightXaxis - 5, $rightYaxis + 5, $linestyle);
