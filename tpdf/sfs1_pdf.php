...
$leftYaxis=$pdf->Show_Drug_History($appointmentID,$leftXaxis,$leftYaxis + 5, 80 , $size , "OLDDRUGS" , "Old Drugs");
$leftYaxis=$pdf->Show_Drug_History($appointmentID,$leftXaxis,$leftYaxis + 5, 80 , $size , "CURRDRUGS" , "Current Drugs");
...
$leftYaxis=$pdf->Show_inv($appointmentID,$leftXaxis,$leftYaxis + 5, 60 , $size);
...
$pdf->Line($rightXaxis - 10 , $vitalEnds, $rightXaxis - 10, $rightYaxis, $linestyle);
